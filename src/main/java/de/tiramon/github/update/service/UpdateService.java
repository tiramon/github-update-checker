package de.tiramon.github.update.service;
...
import de.tiramon.github.update.model.SemanticVersion;
...
public class UpdateService {
	...
	private String latestReleaseApiUrl;

	public UpdateService(String latestReleaseApiUrl) {
	...
	private SemanticVersion getNewestGithubVersion() throws ParseException {
		...
		try {
			...
			gitHubReleaseInformation = gson.fromJson(jsonString, GitHubReleaseInformation.class);
